...
Output Files
------------
This tool has four main outputs when runing in "Compare with Expert Scoring mode":
   - The detected sleep stages are stored in a Snooz accessory file (If the accessory file was provided, the detected sleep stages will be stored in the same accessory file).
   - The expert annotated and predicted hypnogram along with the confusion matrix, accuracy, average confidence, and Kappa score are exported as a PDF file.
   - The hypnodensity plot is exported as a separate PDF file.
   - A complete cohort report is generated in a tsv file, which includes the subject names, accuracy, average confidence, Kappa score, and f1-scores for each subject.
...
**1. Input Files**
   ...
   The YASA sleep scoring tool supports various input file formats, including EDF, NATUS, and Stellate.
...
**An Overview of the results**
   - The expert annotated hypnogram, confusion matrix, accuracy, average confidence, and Kappa score for a subject are shown in **Figure 1**.

.. _results:

.. image:: ./YASA_Automatic_Sleep_Scoring/Hypnogram.png
   :width: 400
...
.. image:: ./YASA_Automatic_Sleep_Scoring/ConfusionMatrix.png
   :width: 350
...
**Figure 1:** The exported results of the YASA sleep scoring tool
   ...
   -  Figure 2 shows the hypnodensity plot generated by the YASA sleep scoring tool, which provides a visual representation of the probability of each sleep stage over time.
.. image:: ./YASA_Automatic_Sleep_Scoring/Hypnodensity.png
   :width: 500
   :alt: Hypnodensity plot
   :align: center

.. rst-class:: center-caption

**Figure 2:** The hypnodensity plot generated by the YASA sleep scoring tool
