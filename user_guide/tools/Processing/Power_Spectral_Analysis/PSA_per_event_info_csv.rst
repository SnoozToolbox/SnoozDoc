...
The total, per hour, and per sleep cycle parameters are computed for each event.

.. note::

   To download the original info.tsv file : `snooz_1_1_0_PSA_per_events_info.tsv <https://f004.backblazeb2.com/file/snooz-release/doc/snooz_1_1_0_PSA_per_events_info.tsv>`_

.. csv-table:: EEG spectral power report per events
   :file: snooz_1_1_0_PSA_per_events_info.tsv
   :delim: tab
   :align: left
